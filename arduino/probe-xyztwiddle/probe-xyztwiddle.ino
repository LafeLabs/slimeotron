// probe-xyztwiddle
// x0 is voltaget on A0 input, which is subtracted from a top voltage x1, 
// then  multiplied by the gain g to get "side", test if side is near zero and set it to zero
// move up and down by "side".  high signal suppresses movement.  
// movement is x,y, and z.
